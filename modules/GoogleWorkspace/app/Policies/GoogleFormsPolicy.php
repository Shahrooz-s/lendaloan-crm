...
class GoogleFormsPolicy
{
     ...
     */
    public function view(User $user, GoogleForms $sheet): bool
    {
     ...
     */
    public function delete(User $user, GoogleForms $sheet): bool
    {
     ...
     */
    public function bulkDelete(User $user, ?GoogleForms $sheet = null)
    {
        if (! $sheet) {
