...
class GoogleSheetsPolicy
{
     ...
     */
    public function view(User $user, GoogleSheets $sheet): bool
    {
     ...
     */
    public function delete(User $user, GoogleSheets $sheet): bool
    {
     ...
     */
    public function bulkDelete(User $user, ?GoogleSheets $sheet = null)
    {
        if (! $sheet) {
