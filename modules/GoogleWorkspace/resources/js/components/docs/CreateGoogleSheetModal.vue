<template>
  <ISlideover
    id="createGoogleSheetModal"
    :visible="visible"
    :title="title || $t('googleworkspace::google.create_google_sheet')"
    :ok-text="$t('core::app.create')"
    :ok-disabled="form.busy"
    static
    form
    @hidden="handleModalHiddenEvent"
    @submit="createGoogleSheet"
...
const { t } = useI18n()
const resourceName = Innoclapps.resourceName('google-sheets')
