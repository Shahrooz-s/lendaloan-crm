<template>
  <ISlideover
    id="createGoogleFormModal"
    :visible="visible"
    :title="title || $t('googleworkspace::google.create_google_form')"
    :ok-text="$t('core::app.create')"
    :ok-disabled="form.busy"
    static
    form
    @hidden="handleModalHiddenEvent"
    @submit="createGoogleForm"
...
const { t } = useI18n()
const resourceName = Innoclapps.resourceName('google-forms')
