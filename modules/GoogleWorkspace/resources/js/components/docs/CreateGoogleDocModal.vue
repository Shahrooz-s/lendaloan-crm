<template>
  <ISlideover
    id="createGoogleDocModal"
    :visible="visible"
    :title="title || $t('googleworkspace::google.create_google_doc')"
    :ok-text="$t('core::app.create')"
    :ok-disabled="form.busy"
    static
    form
    @hidden="handleModalHiddenEvent"
    @submit="createGoogleDoc"
...
const { t } = useI18n()
const resourceName = Innoclapps.resourceName('google-docs')
