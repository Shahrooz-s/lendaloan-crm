<template>
  <ISlideover
    id="createGoogleSlideModal"
    :visible="visible"
    :title="title || $t('googleworkspace::google.create_google_slide')"
    :ok-text="$t('core::app.create')"
    :ok-disabled="form.busy"
    static
    form
    @hidden="handleModalHiddenEvent"
    @submit="createGoogleSlide"
...
const { t } = useI18n()
const resourceName = Innoclapps.resourceName('google-slides')
