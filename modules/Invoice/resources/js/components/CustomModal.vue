...
import IDialogCloseButton from '@/Core/components/UI/Dialog/IDialogCloseButton.vue'
import IDialogOverlay from '@/Core/components/UI/Dialog/IDialogOverlay.vue'
import IDialogTitle from '@/Core/components/UI/Dialog/IDialogTitle.vue'
import propsDefinition from '@/Core/components/UI/Dialog/props'
import { useDialog, useDialogSize } from '@/Core/components/UI/Dialog/useDialog'
